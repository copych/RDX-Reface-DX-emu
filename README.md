...
Yet, by default it's a USB-MIDI device that one can use with some midi host. It understands almost every documented midi feature of a Reface DX, though I don't know how the original behaves exactly, I've never had my hands on a real Reface synth.
