...
// 8 * 5 really, cp437 based
static uint8_t const  font_mo[240][5] = {
	{ 0x44, 0x44, 0x5F, 0x44, 0x44 },  // 10  16 plus minus
	{ 0x2A, 0x2A, 0x2A, 0x2A, 0x2A },  // 11  17 congruence
	...
	{ 0x00, 0x00, 0xFE, 0x01, 0x03 },  // 1B  27 almost equal
	{ 0x50, 0x50, 0x50, 0x50, 0x50 },  // 1C  28 lower equal
	{ 0x18, 0x04, 0x18, 0x20, 0x18 },  // 1D  29 lower tilda 
	{ 0x1D, 0x15, 0x17, 0x00, 0x00 },  // 1E  30 upper 2
	{ 0x15, 0x15, 0x1F, 0x00, 0x00 },  // 1F  31 upper 3
	...
	{ 0x0E, 0x11, 0x11, 0x11, 0x0E },  // 80 128 o empty
	{ 0x0E, 0x1f, 0x1f, 0x1f, 0x0E },  // 81 129 o filled
	{ 0x04, 0x07, 0x04, 0x00, 0x00 },  // 82 130 marker up
	{ 0x01, 0x07, 0x01, 0x00, 0x00 },  // 83 131 marker down
	{ 0x07, 0x02, 0x02, 0x00, 0x00 },  // 84 132 marker right
	{ 0x00, 0x00, 0x02, 0x02, 0x07 },  // 85 133 marker left
	{ 0x18, 0x0C, 0x06, 0x03, 0x1F },  // 86 134 saw
	{ 0x1F, 0x01, 0x01, 0x01, 0x1F },  // 87 135 square
	{ 0x10, 0x18, 0x0C, 0x06, 0x1F },  // 88 136 saw 2
	{ 0x38, 0x55, 0x54, 0x55, 0x18 },  // 89 137 ё (‰)
	{ 0x7F, 0x00, 0x7F, 0x00, 0x00 },  // 8A 138 ll (Š)è
	{ 0x7e, 0x05, 0x00, 0x7e, 0x05 },  // 8B 139 ff (‹)ï
	{ 0x00, 0x4A, 0x79, 0x42, 0x00 },  //	8C 140	î
	{ 0x00, 0x49, 0x7A, 0x40, 0x00 },  //	8D 141	ì
	{ 0x70, 0x29, 0x24, 0x29, 0x70 },  //	8E 142	Ä
	{ 0x70, 0x2A, 0x2D, 0x2A, 0x70 },  //	8F 143	Å
	{ 0x7C, 0x54, 0x56, 0x55, 0x44 },  //	90 144	É
	{ 0x24, 0x54, 0x78, 0x54, 0x58 },  //	91 145	æ
	{ 0x7E, 0x09, 0x7F, 0x49, 0x49 },  //	92 146	Æ
	{ 0x30, 0x4A, 0x49, 0x4A, 0x30 },  //	93 147	ô
	{ 0x30, 0x4A, 0x48, 0x4A, 0x30 },  //	94 148	ö
	{ 0x30, 0x49, 0x4A, 0x48, 0x30 },  //	95 149	ò
	{ 0x38, 0x42, 0x41, 0x22, 0x78 },  //	96 150	û
	{ 0x38, 0x41, 0x42, 0x20, 0x78 },  //	97 151	ù
	{ 0x0C, 0x51, 0x50, 0x51, 0x3C },  //	98 152	ÿ
	{ 0x3D, 0x42, 0x42, 0x42, 0x3D },  //	99 153	Ö
	{ 0x3C, 0x41, 0x40, 0x41, 0x3C },  //	9A 154	Ü
	...
	{ 0x30, 0x48, 0x45, 0x40, 0x20 },  //	9F 159	ƒ
	{ 0x20, 0x54, 0x56, 0x55, 0x78 },  //	A0 160	á
	{ 0x00, 0x48, 0x7A, 0x41, 0x00 },  //	A1 161	í
	{ 0x30, 0x48, 0x4A, 0x49, 0x30 },  //	A2 162	ó
	{ 0x38, 0x40, 0x42, 0x21, 0x78 },  //	A3 163	ú
	{ 0x1C, 0x22, 0x7F, 0x22, 0x22 },  //	A4 164	ñ
	{ 0x48, 0x7E, 0x49, 0x49, 0x42 },  //	A5 165	Ñ
	{ 0x15, 0x16, 0x7C, 0x16, 0x15 },  //	A6 166	ª
	{ 0x7F, 0x05, 0x15, 0x7A, 0x50 },  //	A7 167	º
	...
	{ 0xFE, 0x01, 0x49, 0x4E, 0x30 },  //	E0 224	α
	{ 0x04, 0x98, 0x60, 0x18, 0x04 },  //	E1 225	ß
	{ 0x30, 0x4A, 0x4D, 0x49, 0x32 },  //	E2 226	Γ
	{ 0x38, 0x54, 0x54, 0x54, 0x44 },  //	E3 227	π
	{ 0x31, 0x49, 0x45, 0x43, 0x81 },  //	E4 228	Σ
	{ 0x04, 0x78, 0x04, 0x04, 0xF8 },  //	E5 229	σ
	{ 0x3E, 0x49, 0x49, 0x3E, 0x00 },  //	E6 230	µ
	{ 0x00, 0x00, 0x3C, 0x40, 0x40 },  //	E7 231	τ
	{ 0x00, 0x7C, 0x10, 0x28, 0x44 },  //	E8 232	Φ
	{ 0x40, 0x31, 0x0F, 0x30, 0x40 },  //	E9 233	Θ
	{ 0xFC, 0x40, 0x40, 0x3C, 0x40 },  //	EA 234	Ω
	{ 0x3C, 0x40, 0x20, 0x14, 0x0C },  //	EB 235	δ
	{ 0x61, 0x95, 0x8B, 0x89, 0x09 },  //	EC 236	∞
	{ 0x44, 0x3C, 0x04, 0x7C, 0x44 },  //	ED 237	φ
	{ 0xF8, 0x44, 0x44, 0x44, 0x38 },  //	EE 238	ε
	...
	{ 0xFF, 0x81, 0x81, 0x81, 0xFF },  //	FC 252	ⁿ
